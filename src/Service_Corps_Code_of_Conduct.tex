...
\begin{document}
    ...
    \def \versionNumber {3.3}
    \stdFooter
    \begin{titlepage}
        \stdTitlePage
    \end{titlepage}
    \begin{enumerate}
        \item Follow the Scouts Canada Promise, the Law, Motto, and BY-LAW, POLICIES, AND PROCEDURES (BP\&P) or the Girl Guides of Canada Vision, Mission, Values, Promise, Law, and Code of Conduct.
        ...
        \item Work cooperatively as a team member with the Executive as well as the rest of the members of the Company/Crew/Unit.
